...
tar xf Linux_x86_64_1680647257_Release.tar.zst -C ${DEP_ROOT}/Linux_x86_64_Release &
tar xf Linux_x86_64_1680647257_Debug.tar.zst -C ${DEP_ROOT}/Linux_x86_64_Debug &
